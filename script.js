...
const datosPerros = {
    chihuahua: {
        nombre: "Chihuahua",
        comida_ideal: "Para razas pequeñas (croqueta pequeña), proteína 26-30%, control de grasa.",
        variantes: [
    ...
    beagle: {
        nombre: "Beagle",
        comida_ideal: "Para razas medianas, control de calorías, proteína moderada y fibra para saciedad.",
    ...
    bulldog: {
        ...
        comida_ideal: "Formulado para braquicéfalos; ingredientes digestibles y proteína de calidad; baja en grasa.",
    ...
    cocker: {
        ...
        comida_ideal: "Equilibrado, rico en proteína y omega-3 para piel y pelo; porciones controladas.",
    ...
    labrador: {
        ...
        comida_ideal: "Para razas activas con control de calorías y proteína de calidad; vigilar porciones.",
    ...
    golden: {
        ...
        comida_ideal: "Con glucosamina y omega-3 para soporte articular y pelaje sano; ajustar calorías según actividad.",
    ...
    pastor: {
        ...
        comida_ideal: "Para razas grandes con soporte articular (glucosamina) y control del crecimiento en cachorros.",
    ...
    husky: {
        ...
        comida_ideal: "Energético y alto en proteína y grasas saludables; ideal para perros muy activos.",
    ...
    rottweiler: {
        nombre: "Rottweiler",
        comida_ideal: "Para razas grandes y musculosas, proteína alta y soporte articular; controlar calorías.",
    ...
    "gran-danes": {
        nombre: "Gran Danés",
        comida_ideal: "Específico para razas gigantes: control de crecimiento, calcio equilibrado y soporte articular.",
